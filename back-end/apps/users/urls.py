...
from .views import CheckUserView, CreateUserView, UserListView, UserDetailView, UpdateUserView, DeleteUserView
...
urlpatterns = [
    ...
    path(r"check_user/<str:phone_number>/", view=CheckUserView.as_view(), name="check_user"),
