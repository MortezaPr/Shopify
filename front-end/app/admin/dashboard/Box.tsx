...
const Box: React.FC<BoxProps> = ({ title, icon: Icon, accent, data }) => {
  return (
    <div className="cursor-pointer h-40 w-[27rem] md:w-[14rem] lg:w-[20rem] xl:w-[16rem] 2xl:w-[19rem] rounded-lg bg-white dark:bg-dark-bg dark:text-white shadow-md hover:shadow-lg pt-7 pr-4">
      <div className="pr-3">
        <Icon
          style={{
            color: `${accent}`,
